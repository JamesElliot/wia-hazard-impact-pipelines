...
from wia_pipelines.hazards.utci_parity import run_checks, to_markdown


def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="Run standardized UTCI post-run checks (schema + parity).")
    p.add_argument("--run-dir", required=True, help="Path to UTCI run directory.")

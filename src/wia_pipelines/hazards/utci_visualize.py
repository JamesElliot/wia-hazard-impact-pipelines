...
def write_run_maps(
    ...
    *,
    ...
    footprint_map = output_dir / f"{iso3}_extreme_heat_affected_population_{window_end}.png"
    ...
    plot_hazard_footprint(
        ...
        footprint_map,
        iso3=iso3,
        hazard_label=f"extreme heat exposure ({default_threshold_label})",
    ...
    plot_admin_pct_affected(
        ...
        iso3=iso3,
        hazard_label="population exposed to extreme heat",
        admin_level=admin_level,
        window_start=window_start,
        window_end=window_end,
    )
    return {"extreme_heat_affected_population": footprint_map, "admin_percent_affected": admin_map}

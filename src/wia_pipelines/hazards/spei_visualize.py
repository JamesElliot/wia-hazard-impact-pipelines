...
def write_run_maps(
    ...
    *,
    ...
    footprint_map = output_dir / f"{iso3}_water_scarcity_affected_population_{window_end}.png"
    ...
    plot_admin_pct_affected(
        ...
        iso3=iso3,
        hazard_label="population affected by water scarcity",
        admin_level=admin_level,
        window_start=window_start,
        window_end=window_end,
        cmap="YlOrBr",
    )
    return {"water_scarcity_affected_population": footprint_map, "admin_percent_affected": admin_map}
